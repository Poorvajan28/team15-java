...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/resources/**").permitAll()  // Allow all resource endpoints
                .requestMatchers("/api/bookings/**").permitAll()  // Allow all booking endpoints
                .requestMatchers("/api/dashboard/**").permitAll()  // Allow dashboard
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("*")); // Allow all origins for debugging
